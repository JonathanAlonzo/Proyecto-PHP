                ...
                <form class="mx-1 mx-md-4">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <label class="form-label" for="form3Example3c">Email</label>
                      ...
                      <input type="email" id="form3Example3c" class="form-control shadow" />
                    </div>
                  </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <label class="form-label" for="form3Example4c">Contraseña</label>
                      ...
                      <input type="password" id="form3Example4c" class="form-control shadow" />
                    </div>
                  </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <label class="form-label" for="form3Example4cd">Verifique su contraseña</label>
                      ...
                      <input type="password" id="form3Example4cd" class="form-control shadow" />
                    </div>
                  </div>
